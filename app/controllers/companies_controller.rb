class CompaniesController < ApplicationController
    ...
    def create
        ...
        if params[:company][:contacts_attributes]["0"][:primary_contact] =='on'
            @company.primary_contact_id = @company.contacts.last.id
            @company.save
        end
    ...
    def company_params
        params.require(:company).permit(
            ...
            :contact_email, :company_notes, :contact_notes, :last_meeting, :last_meeting_notes, 
            contacts_attributes: [
